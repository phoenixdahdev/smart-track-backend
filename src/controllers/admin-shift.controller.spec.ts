...
describe('AdminShiftController', () => {
  let controller: AdminShiftController;
  let shiftService: {
    create: jest.Mock;
    listAll: jest.Mock;
  ...
  beforeEach(() => {
    ...
    controller = new AdminShiftController(shiftService as never);
  });
  ...
  describe('GET /admin/shifts/by-staff/:staffId', () => {
  ...
  describe('GET /admin/shifts/by-individual/:individualId', () => {
    it('should list shifts by individual', async () => {
  ...
  describe('PATCH /admin/shifts/:id', () => {
  ...
  describe('PATCH /admin/shifts/:id/publish', () => {
  ...
  describe('PATCH /admin/shifts/:id/cancel', () => {
