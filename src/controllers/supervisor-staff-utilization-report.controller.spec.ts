...
describe('SupervisorStaffUtilizationReportController', () => {
  let controller: SupervisorStaffUtilizationReportController;
  ...
  beforeEach(() => {
    ...
    controller = new SupervisorStaffUtilizationReportController(
