...
export class AuthEnhancements1772835687581 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "users" DROP CONSTRAINT "UQ_6d4919bbde4f4f1e2a132f9317d"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "otp_code" character varying(6)`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ALTER COLUMN "role" SET DEFAULT 'DSP'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "public"."idx_users_email"`);
    await queryRunner.query(
      `ALTER TABLE "users" ALTER COLUMN "status" SET DEFAULT 'PENDING_INVITE'`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "users" ADD "auth0_sub" character varying(255)`,
    );
    await queryRunner.query(
      `ALTER TABLE "users" ADD CONSTRAINT "UQ_6d4919bbde4f4f1e2a132f9317d" UNIQUE ("auth0_sub")`,
    );
    await queryRunner.query(
